            ...
            vbox:
                ...
                hbox:
                    ...
                    vbox:
                        ...
                        bar value FieldValue(object=persistent, field='pref_text_size_label', range=(wells_text_size * 2), max_is_zero=False, style=u'slider', offset=0, step=1)
                    vbox:
                       label _("Tamanho do dialogo: %s" % (persistent.pref_text_size_dialogue))
                       bar value FieldValue(object=persistent, field='pref_text_size_dialogue', range=(wells_text_size * 2), max_is_zero=False, style=u'slider', offset=0, step=1)
...
init -1 style say_wells_1280:
    ...
    background Solid("#000000a6", xalign=0.5, yalign=1.0)
...
init -1 style namebox_wells_1280:
    ...
    background Frame("wells/namebox.png", wells_namebox_borders, tile=False, xalign=0.0)
...
init -1 style say_wells_1920:
    ...
    background Image("wells/textbox.png", xalign=0.5, yalign=1.0)
