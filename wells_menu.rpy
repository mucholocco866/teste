    ...
    frame:
        ...
        vbox:
            ...
            hbox:
                ...
                # --- COLUNA 1: SELETOR DE FONTES (Substituiu o Test Tools) ---
                vbox:
                ...
                # --- COLUNA 2: SYSTEM & PERFORMANCE (Sua configuração original) ---
                vbox:
                    xsize 450 spacing 15
                    text "SYSTEM" xalign 0.5 size 28 color "#ff4444"
                    
                    vbox:
                        spacing 5 xfill True
                        text "VIDEO PERFORMANCE" size 28 color "#aaa" xalign 0.5
                    ...
                    # --- DENTRO DA COLUNA SYSTEM ---
                    vbox:
                        spacing 2 xfill True
                        text "Escala de altura do texto:" size 24 xalign 0.5
...
init 999 screen say(who, what):
    ...
    window:
        ...
        text what:
            if config.screen_width == 1920:
                ypos -15
                # O yoffset aplica o deslocamento vertical definido pelo slider
                yoffset (persistent.wells_dialogue_y_offset if persistent.wells_dialogue_y_offset is not None else 0)
                if who is None:
                    xalign 0.2
                else:
            ...
            # Aplica o espaçamento definido no seu menu experimental
            line_spacing (persistent.wells_line_spacing if persistent.wells_line_spacing is not None else 5)
