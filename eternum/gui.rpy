...
#    stop soundloop fadeout 4
#    play sound risingshort4
#    scene login3 with dis2
#    pause 6
#    play soundlow whoosh4
#    scene white with dissolve
#    play music2 rain3 fadein 5
#    scene sc 1 with flash 
#    play sound2 beep
#    mc "Ah" with dissolve
...
#    play sound risingshort4
#    pause 2
#    scene login3 with flash
#    pause 8
#    play soundlow whoosh4
#    scene white with dissolve
#    play soundloop wind fadein 3
#    scene dr 1 with dis25
...
# –
# “”
# play sound2 ["<silence 0.6>", doorclose2]
# play music2 ["<silence 2>"]


# $ renpy.music.set_volume(0.2, channel='music3')
# $ renpy.music.set_volume(0.2, delay=20.0, channel='music3')
...
# call screen zoom_image("images/09/qqi 70.jpg")
...
define gui.hover_color = '#02ffbf'

## The color used for a text button when it is selected but not focused. A
## button is selected if it is the current screen or preference value.
define gui.selected_color = '#02ffbf'
...
define gui.radio_button_borders = Borders(48, 6, 6, 6)
define gui.radio_button_text_selected_hover_color = gui.idle_color
define gui.check_button_borders = Borders(48, 6, 6, 6)
define gui.check_button_text_selected_hover_color = gui.idle_color

define gui.confirm_button_text_xalign = 0.5

define gui.page_button_borders = Borders(5, 6, 5, 6)
